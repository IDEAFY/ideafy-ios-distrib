           ...
           return function MessageReplyConstructor(){
                ...
                messageReplyUI.send = function(event, node){
                                ...
                                if (!sendInProgress){
                                        ...
                                        json.signature = msgReply.get("signature");
                                        json.author =  msgReply.get("author");
                                        json.username = msgReply.get("username");
                                        json.firstname = msgReply.get("firstname");
                                        json.toList = msgReply.get("toList");
                                        json.ccList = msgReply.get("ccList");
                                        json.object = msgReply.get("object");
